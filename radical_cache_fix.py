#!/usr/bin/env python3
"""
Radical Cache-Busting Script for Crane Intelligence Platform
This script will force update the production server with cache-busting techniques
"""
...
def main():
    ...
    cache_commands = [
        ...
        "find /var/www/crane-intelligence -name '*.html' -exec rm {} \\;"
    ]
    ...
    for cmd in cache_commands:
        ...
        if success:
            ...
            print(f"⚠️ Cache clear: {stderr}")
    
    # Step 3: Force update with timestamp
    print("\n3️⃣ Force updating files with timestamp...")
    
    # Create a new homepage with timestamp
...
<body>
    ...
    <main>
        <section id="home" class="hero">
            <div class="hero-content">
                <h1>Professional Crane Valuation Platform</h1>
    ...
    <footer>
        <div class="container">
            <p>&copy; 2024 Crane Intelligence. All rights reserved.</p>
        </div>
    </footer>
    ...
    print(f"\n4️⃣ Creating new homepage with timestamp {timestamp}...")
...
EOF'''
    ...
    if success:
        print("✅ New homepage created with timestamp")
    else:
        print(f"❌ Failed to create homepage: {stderr}")
        return
    
    # Step 5: Update Nginx with aggressive cache busting
    print("\n5️⃣ Updating Nginx with radical cache busting...")
...
EOF'''
    ...
    if success:
        print("✅ Nginx configuration updated with radical cache busting")
    else:
        print(f"❌ Failed to update Nginx: {stderr}")
        return
    ...
    # Test the domain
    test_commands = [
        "curl -s https://craneintelligence.tech | grep -i 'timestamp'",
