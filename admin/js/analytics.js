...
class AnalyticsManager {
    ...
    bindEvents() {
        ...
        window.addEventListener('resize', () => {
            ...
            resizeTimeout = // setTimeout(// DISABLED to prevent flickering // () => this.resizeCharts(), 250);
        });
    }
    ...
    showSuccess(message) {
        ...
        // setTimeout(// DISABLED to prevent flickering // () => notification.remove(), 3000);
    }
    ...
    showError(message) {
        ...
        notification.textContent = message;
        document.body.appendChild(notification);
        // setTimeout(// DISABLED to prevent flickering // () => notification.remove(), 5000);
    }
}
