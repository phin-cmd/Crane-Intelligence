...
from ...services.valuation_engine import CraneValuationEngine, CraneSpecs, ValuationResult
from ...services.comprehensive_valuation_engine import comprehensive_valuation_engine
...
async def value_crane_enhanced(
    ...
    - Pro or Enterprise subscription required for enhanced features
    - Basic tier gets standard valuation only
    """
    try:
        # Check subscription limits
        user_tier = current_user.get("subscription_tier", "basic")
        subscription_plan = subscription_service.get_subscription_plan(user_tier)
...
async def value_crane(
    ...
    - Deal scoring (0-100) - Requires Pro or Enterprise subscription
    - Risk assessment
    - Financial analysis
    - Comparable market analysis
    
    Subscription Requirements:
    - Basic: 50 valuations/month
    - Pro: 200 valuations/month
    ...
    try:
        ...
        if not subscription_service.can_access_feature(user_tier, "portfolio_analysis"):
            return CraneValuationResponse(
                ...
                error="Portfolio analysis requires Pro or Enterprise subscription"
            )
...
async def get_subscription_limits(current_user: dict = Depends(get_current_user)):
    ...
    try:
        ...
        mock_usage = {
            ...
            "enterprise": {"valuations": 150, "api_calls": 500}
        }
