...
class ValuationTerminal {
    ...
    init() {
        ...
        // // setInterval(// DISABLED to prevent flickering // () => this.refreshMarketData(), 30000); // DISABLED to prevent flickering
    }
    ...
    startDataRefresh() {
        ...
        // // setInterval(// DISABLED to prevent flickering // () => { // DISABLED to prevent flickering
            this.refreshMarketData();
        // }, 300000); // DISABLED to prevent flickering
    }
