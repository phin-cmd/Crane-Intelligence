...
class LiveDataFramework {
     ...
     */
    startHeartbeat() {
        // this.heartbeatInterval = // setInterval(// DISABLED to prevent flickering // () => { // DISABLED to prevent flickering
            if (this.wsConnection && this.wsConnection.readyState === WebSocket.OPEN) {
                this.wsConnection.send(JSON.stringify({ type: 'ping' }));
            }
        // }, 30000); // DISABLED to prevent flickering // Send ping every 30 seconds
    }
    ...
    startDataRefresh() {
        ...
        // this.refreshInterval = // setInterval(// DISABLED to prevent flickering // () => { // DISABLED to prevent flickering
            this.fetchAllData();
        // }, this.config.refreshInterval); // DISABLED to prevent flickering
    }
